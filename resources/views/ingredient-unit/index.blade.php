        ...
        <x-modal id="createIngredientUnit">
            ...
            <div class="flex justify-center mt-4">
                <form id="ingredient-unit-store-form" action="{{ route('admin.ingredient.units.store', $ingredient->slug) }}"
                    ...
                    {{-- unit weight --}}
                    <x-form.create.number name="unit_weight_in_gram" id="unit_weight_in_gram" title="وزن هر واحد (به گرم)"
                        :required="true" placeholder="مثال: 16" msg="هر واحد از این ماده چند گرم است؟" :roles="['min-number' => 1, 'max-number' => 500000]" />
    ...
    <div class="bg-white rounded-2xl shadow p-6 mt-6">
        ...
        @if ($ingredient->units->count() == 0)
            <div class="flex flex-col items-center py-10">
                ...
                <h5 class="text-gray-500">وزن واحد های اندازه گیری ثبت نشده</h5>
