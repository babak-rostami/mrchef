    ...
    <div class="md:mx-8 lg:mx-44">
        ...
        <form id="category-update-form" action="{{ route('admin.category.update', $category->slug) }}" method="POST"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {{-- NAME --}}
                <x-form.edit.input name="name" id="name" title="نام" placeholder="مثال: سوخاری" :required="true"
                ...
                <div class="md:col-span-2 gap-4 mt-2">
                    ...
                    <x-form.edit.textarea title="توضیحات" name="description" id="description"
                        placeholder="توضیح درباره دسته بندی ..." msg="یک توضیح برای دسته بندی بنویسید" :required="true"
                        :roles="['min-len' => 25]" :value="$category->description" />
