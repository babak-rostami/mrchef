            ...
            <div class="flex justify-center">
                <form id="recipes-update-form" action="{{ route('recipes.update', $recipe->slug) }}" method="POST"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {{-- TITLE --}}
                        <x-form.edit.input name="title" id="title" title="عنوان"
                            placeholder="مثال: طرز تهیه پاستا مخصوص" :required="true" msg="حداکثر 55 کاراکتر برای سئو بهتر"
                            :roles="['min-len' => 15, 'max-len' => 55]" :value="$recipe->title" />
                        ...
                        {{-- TIME PREPARE --}}
                        <x-form.edit.number name="time_prepare" id="time_prepare" title="زمان آماده سازی"
